...
prefab-scene-canvas-explorer は Rank 67 の UnityEditor プロダクトです。作業はこのリポジトリ内に限定します。

## Scope

- Repository: D:/AI/UnityEditor/prefab-scene-canvas-explorer
- GitHub: https://github.com/Sunmax0731/prefab-scene-canvas-explorer
